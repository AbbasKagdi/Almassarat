...
<html lang="en">
  <head>
    <title>Create a blog | Almassarat</title>
    <meta name="description" content="Admin Panel | Almassarat" />
    <!-- Load Headers -->
...
<!-- front section -->
<div><img id="banner" class="img-fluid w-100" src="img/banners/n4.jpg" /></div>
...
<div class="container my-5 border">
		...
		<form class="form border p-5" enctype="multipart/form-data">
			...
			<div class="input-group mb-3">
				<select class="form-control" id="brand" name="brand">
					...
					<option value='0'>Ultratecno</option>
				</select>
			</div>
			<!-- Image -->
			<div class="form-row">
			...
			<div class="form-row">
				<div>
					...
					<label class="checkbox-inline p-2 badge badge-warning">
	...
	<hr>
	<p class="lead">Approve Blog. <button onclick="approver(1)" id='modgrt' class="btn border-danger mx-2">GRT</button><button onclick="approver(0)" id='modut' class="btn border-primary">Ultratecno</button></p><hr>
	<p class="lead">Manage Dashboard. <button onclick="dasher(1)" id='dashgrt' class="btn border-danger mx-2">GRT</button><button onclick="dasher(0)" id='dashut' class="btn border-primary">Ultratecno</button></p><hr>
			...
			$.ajax({
				...
				success: function(result){
					...
					//Success
						...
						$('#rst').click();
						document.location.href = company + '-news.php';
					}
					//Pending approval
					else if(result=="okay"){
