<?php
	...
	try{
		...
		if(in_array($bid, $log['posts'])){
			$blog = json_decode(file_get_contents("static/blogs/grt/". $bid .".json"), true);
		}
...
<html lang="en">
  <head>
    <title>GRT | <?php echo $blog['title']; ?> | Almassarat</title>
    <meta name="description" content="GRT | <?php echo $blog['title']; ?> | Almassarat" />
    <meta name="keywords" content="Almassarat, GRT">
    <link rel="canonical" href="https://almassarat.com/grt-feed.php">
    <!-- Load Headers -->
...
?>
<!-- front section -->
<div><img id="banner" class="img-fluid w-100" src="img/blogs/grt/<?php echo $blog['image']; ?>" /></div>
